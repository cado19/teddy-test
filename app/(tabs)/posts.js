  ...
  return (
    <View style={styles.topContainer}>
      ...
      <View style={styles.icons}>
        <Pressable onPress={() => navigation.navigate("megusta")}><FontAwesome name="star" size={30} color='white' /></Pressable>
        <Pressable onPress={() => navigation.navigate("commentar")} style={{ marginLeft: 10 }}><FontAwesome name="comment" size={30} color='#72009E' /></Pressable>
      </View>
    </View>
  );
}
